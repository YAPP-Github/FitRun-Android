import com.yapp.fitrun.configureVerifyDetekt
...
tasks.withType<io.gitlab.arturbosch.detekt.Detekt>().configureEach {
    ...
    parallel = true
    config.setFrom(listOf(file("$rootDir/detekt-config.yml"))) // point to your custom config defining rules to run, overwriting default behavior
